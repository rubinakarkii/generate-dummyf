...
class JsonTestCase(unittest.TestCase):
    def test_invalid_file_size_data_type(self):
        ...
        self.assertRaises(InvalidInputDataTypeException, generate_json("1000"))
    ...
    def test_invalid_column_description_value_data_type(self):
        ...
        self.assertRaises(InvalidInputDataTypeException, generate_json(3824, {"Roll No.": int}))

    def test_invalid_file_path(self):
        """Case 3: function is given invalid path for saving file"""
        self.assertRaises(InvalidColumnDescriptionValueException, generate_json(1000, save_file_path="bhsdajhbfsdj"))

    def test_invalid_file_size_value(self):
        """Case 4:  function is provided an invalid file size"""
        self.assertRaises(InvalidSizeException, generate_json(-1000))
    ...
    def test_invalid_column_description_value(self):
        ...
        self.assertRaises(InvalidColumnDescriptionValueException, generate_json(1000, {"file": "object"}))
