...
from generate_dummyf.generate import generate_excel
...
class ExcelTestCase(unittest.TestCase):
    def test_invalid_file_size_data_type(self):
        ...
        self.assertRaises(InvalidInputDataTypeException, generate_excel(file_size="1000"))
    ...
    def test_invalid_column_description_value_data_type(self):
        ...
        self.assertRaises(InvalidInputDataTypeException, generate_excel(file_size=3824, column_description={"Roll No.": int}))

    def test_invalid_file_path(self):
        """Case 3: function is given invalid path for saving file"""
        self.assertRaises(InvalidPathException, generate_excel(file_size=1000, save_file_path="bhsdajhbfsdj"))

    def test_invalid_file_size_value(self):
        """Case 4:  function is provided an invalid file size"""
        self.assertRaises(InvalidSizeException, generate_excel(file_size=-1000))
    ...
    def test_invalid_column_description_value(self):
        ...
        self.assertRaises(InvalidColumnDescriptionValueException, generate_excel(file_size=1000, column_description={"file": "object"}))
